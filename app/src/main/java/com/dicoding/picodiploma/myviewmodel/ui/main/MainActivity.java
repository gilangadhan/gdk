package com.dicoding.picodiploma.myviewmodel.ui.main;
...
import com.dicoding.picodiploma.myviewmodel.ui.fav.FavWeatherActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickCallback(new OnItemClickCallback() {
            @Override
            public void onClick(WeatherItems weatherItems) {
                // untuk pindah ke Activity lain
                startActivity(new Intent(MainActivity.this, FavWeatherActivity.class));
                // untuk favorite
                //mainViewModel.setFavorites(weatherItems);
            }
        });
